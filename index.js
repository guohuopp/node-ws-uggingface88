...
const UUID = process.env.UUID || '960a379f-124d-44a3-a6e9-3f5f663c5fc9'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const NEZHA_KEY = process.env.NEZHA_KEY || 'EsGSPZ2kMIui9yfuvmQuzS7YSuIf6yrh';             // v1的NZ_CLIENT_SECRET或v0的agent端口                
const DOMAIN = process.env.DOMAIN || 'node-ws-uggingface88-b4a2.onbelmo.uk';       // 填写项目域名或已反代的域名，不带前缀，例如：abc-domain.com
