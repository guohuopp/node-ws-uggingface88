...
const UUID = process.env.UUID || 'ad9be9d2-e83c-4ea6-8d95-c531237656cd'; // 运行哪吒v1,在不同的平台需要改UUID,否则会被覆盖
...
const DOMAIN = process.env.DOMAIN || 'node-ws-uggingface88-b4a2.onbelmo.uk';       // 填写项目域名或已反代的域名，不带前缀，建议填已反代的域名
